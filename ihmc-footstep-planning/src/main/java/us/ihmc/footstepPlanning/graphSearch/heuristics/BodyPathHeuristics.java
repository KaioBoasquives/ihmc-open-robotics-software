...
public class BodyPathHeuristics extends CostToGoHeuristics
{
   ...
   protected double computeHeuristics(FootstepNode node, FootstepNode goalNode)
   {
      ...
      return remainingDistance + pathDistanceViolationCost + pathYawViolationCost + costParameters.getYawWeight() * remainingYaw + costParameters.getCostPerStep() * minSteps;
   }
